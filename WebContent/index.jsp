...
<body>
	...
	<form class="pure-form" action="index2.jsp">
	<input type="text" id="country" name="location" placeholder="Enter a location"/>
	
	<script>
		$("#country").autocomplete("getdata.jsp");
	</script>
	
	<input class="pure-button pure-button-primary"type="submit" value="Get info">
	</form>
